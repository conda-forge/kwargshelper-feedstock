...
Once the `conda-forge` channel has been enabled, `kwargshelper` can be installed with:

```
conda install kwargshelper
```

It is possible to list all of the versions of `kwargshelper` available on your platform with:
